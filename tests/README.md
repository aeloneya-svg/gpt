...
- Manual instant-play check: open `playable_now/index.html` and verify 3D movement/look/shoot/build, Rift stat changes, walls blocking enemies, and match restart.
